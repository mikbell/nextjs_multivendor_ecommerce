					...
					<div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
						...
						<div className="flex space-x-3">
							...
							<button
								...
								className="flex-1 bg-gray-200  text-sm font-medium py-2 px-4 rounded hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
								Try Again
							</button>
						</div>
					</div>
