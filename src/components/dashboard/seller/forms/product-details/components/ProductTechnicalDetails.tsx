...
export const ProductTechnicalDetails = ({ form, isLoading }: BaseFormProps) => {
	return (
		<div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-200/50 p-8 hover:shadow-xl transition-all duration-300">
			<div className="flex items-center gap-3 mb-6">
				<div className="p-2 bg-linear-to-r from-green-500 to-emerald-500 rounded-xl">
					<Package className="h-5 w-5 text-white" />
				</div>
				<div>
					<h3 className="text-xl font-bold">Dettagli Tecnici</h3>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel className="text-base font-semibold">
								SKU (Codice Prodotto) <span className="text-red-500">*</span>
							</FormLabel>
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							<FormLabel className="text-base font-semibold">
								Peso del Prodotto <span className="text-red-500">*</span>
							</FormLabel>
							<FormDescription className="text-sm text-muted-foreground">
